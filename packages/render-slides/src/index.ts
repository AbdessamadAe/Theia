...
import { inlinedKatexCss } from "./katex-assets.js";
import { renderSlide } from "./render-nodes.js";
import { DECK_RUNTIME } from "./runtime.js";
 ...
 * navigable slide deck with KaTeX-rendered math, styled theorem blocks, step
 * reveal, light/dark themes, and clean placeholders for the not-yet-live
 * features. No external requests — fonts and styles are inlined.
 */
