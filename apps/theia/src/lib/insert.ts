...
function theiaSlashCompletions(context: CompletionContext): CompletionResult | null {
...
export function theiaSlashPalette(): Extension {
  return autocompletion({ override: [theiaSlashCompletions], defaultKeymap: true });
}
